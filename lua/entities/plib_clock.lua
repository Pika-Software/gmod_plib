...
if CLIENT then
	...
	local hours_mat = Material("https://i.imgur.com/BvfYi4f.png", PLib["MatPresets"]["Pic"])
	local mins_mat = Material("https://i.imgur.com/yRMoWa5.png", PLib["MatPresets"]["Pic"])
	local secs_mat = Material("https://i.imgur.com/OiHyZVq.png", PLib["MatPresets"]["Pic"])
